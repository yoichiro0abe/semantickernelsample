...
# 環境変数の値を確認するコードを追加
print("AZURE_DEPLOYMENT_NAME:", os.environ.get("AZURE_DEPLOYMENT_NAME"))
print("AZURE_API_KEY:", os.environ.get("AZURE_API_KEY")[:5] )
print("AZURE_BASE_URL:", os.environ.get("AZURE_BASE_URL"))
